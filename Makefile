...
bootdisk: bootloader kernel
	...
	@echo "Writing Stage 2 bootloader (sectors 1-$(STAGE2_SECTORS))..."
	...
	@echo "Sectors 1-$$STAGE2_SECTORS:        Stage 2 bootloader"; 
	@echo "Sectors $$KERNEL_START_SECTOR-$$(( $$KERNEL_START_SECTOR + $$KERNEL_SECTORS - 1 )):  Kernel"; 
	@echo ""; 
