...
boot:
    ...
    ; Check weather A20 line is enabled by BIOS, if not then enabled it and the status is returned 
    ; in ax 
    ;call check_a20
...
boot_message db "Loading...", 0x0D, 0x0A, 0x0
loading_error db "Disk Error",0x0D, 0x0A, 0x0
